...
ymw16lib = C.CDLL(os.path.join(ymwpath, 'ymw16lib.so'))
...
def ymw16_dist_to_dm(dist, gl, gb):
    ...
    '''
    proc = subprocess.Popen(['/Users/dai02a/Soft/psrpop/PsrPopPy/lib/ymw16/ymw16', '-d', '/Users/dai02a/Soft/psrpop/PsrPopPy/lib/ymw16/', 'Gal', str(gl), str(gb), str(1000.0*dist), str(2)], shell=False, stdout=subprocess.PIPE)
